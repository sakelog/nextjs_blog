...
export const createPages: GatsbyNode['createPages'] = async ({
  ...
  // create PostList
  const postListRes = await graphql<PostList.pathQuery>(PostListQuery);
  if (postListRes.errors || !postListRes.data) {
    throw postListRes.errors;
  }

  const posts = postListRes.data.postListQuery.nodes;
