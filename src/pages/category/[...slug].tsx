...
const CategoryDirectory: NextPage<Template.catTagList.props> =
  (props) => {
    return (
      <Layout>
        <Temp_CatTag
...
export const getStaticProps: GetStaticProps = async (
  ...
  const categoryProps =
    allcategory &&
    (typeof slug === 'string' || Array.isArray(slug))
  ...
  if (allCategory) {
    for (
      ...
      targetPost &&
        targetPost.length > 0 &&
        allSlugs.push([
          toKebabCase(allCategory[index].fields.slug),
        ]);
